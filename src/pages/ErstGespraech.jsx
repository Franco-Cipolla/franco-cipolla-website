        ...
        <form onSubmit={handleSubmit} className="max-w-xl mx-auto" noValidate>
          ...
          <div className="contact-animate flex items-center gap-2 mb-8">
            <input
              ...
              onChange={handleChange}
              onBlur={handleBlur}
              className={`w-5 h-5 border accent-[#003566] rounded-none cursor-pointer ${
                errors.privacy ? 'border-red-500' : 'border-black'
              }`}
            />
            <label
              htmlFor="privacy"
          ...
          <button
            type="submit"
            className="contact-animate py-3 px-6 bg-black text-white rounded cursor-pointer hover:bg-[#000814] transition transform"
          >
            Anfrage senden
          </button>
        </form>

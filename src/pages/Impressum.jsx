        ...
        <div className="max-w-[950px] xl:max-w-[1100px] px-6 py-20">
          ...
          <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
            ...
            <div>
              ...
              <p className="mt-2">
                Als Diensteanbieter bin ich gemäß den allgemeinen Gesetzen für eigene Inhalte auf diesen Seiten verantwortlich.
                Ich bin jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde Informationen zu überwachen oder nach

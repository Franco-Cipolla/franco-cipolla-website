  ...
  return (
    <>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 mt-20 text-black">
        ...
        <p className="text-gray-700 mb-4">
          Ich nutze Google Analytics, einen Webanalysedienst der Google Ireland Ltd., um die Nutzung der Website zu analysieren. Die IP-Adresse wird anonymisiert. Die Nutzung erfolgt auf Grundlage deiner Einwilligung gemäß Art. 6 Abs. 1 lit. a DSGVO.
          Du kannst der Nutzung von Google Analytics jederzeit widersprechen, z.B. durch Deaktivierung von Cookies oder über das <a href="https://tools.google.com/dlpage/gaoptout" className="underline text-[#003566]" target="_blank" rel="noopener noreferrer">Browser-Add-on von Google</a>.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2">6. Cookies</h2>
        <p className="text-gray-700 mb-4">
          Diese Website verwendet Cookies, um bestimmte Funktionen bereitzustellen und die Nutzung zu analysieren. Notwendige Cookies sind für die Funktionsfähigkeit der Website und des Calendly-Widgets erforderlich. Analytische und Marketing-Cookies werden nur nach ausdrücklicher Zustimmung gesetzt.
        </p>
        <p className="text-gray-700 mb-4">
          Du kannst Cookies jederzeit über deine Browsereinstellungen löschen oder blockieren. Das Setzen von Cookies erfolgt ausschließlich auf Grundlage deiner Einwilligung, soweit dies gesetzlich erforderlich ist.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2">7. Externe Inhalte & Drittanbieter</h2>
        <p className="text-gray-700 mb-4">
          Auf dieser Website werden externe Inhalte eingebunden, z.B. Google Fonts, Font Awesome, Instagram-Links und Calendly für Terminbuchungen. Beim Laden dieser Inhalte können personenbezogene Daten (z.B. IP-Adresse) an die jeweiligen Anbieter übermittelt werden, ggf. auch in Länder außerhalb der EU/EEA (z.B. USA).
          Die Übertragung in Länder ohne angemessenes Datenschutzniveau erfolgt auf Grundlage deiner Einwilligung bzw. auf Basis geeigneter Schutzmaßnahmen (z.B. Standardvertragsklauseln).
          Die Einbindung erfolgt zur visuellen Gestaltung, Nutzerfreundlichkeit und Terminabwicklung.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2">8. Datensicherheit</h2>
        <p className="text-gray-700 mb-4">
          Ich setze technische und organisatorische Maßnahmen (TOMs) ein, um deine Daten vor Verlust, Missbrauch und unberechtigtem Zugriff zu schützen. Dazu zählen u.a. verschlüsselte Übertragung (HTTPS), regelmäßige Backups und Zugriffsbeschränkungen.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          ...
          Du kannst dich jederzeit per E-Mail: <a href="mailto:franco_cipolla@web.de" className='text-[#003566]'>franco_cipolla@web.de</a> oder WhatsApp: +49 176 753 98004 an mich wenden.
        </p>

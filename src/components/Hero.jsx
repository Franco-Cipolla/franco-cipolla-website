  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden">
        <span ref={leftCircleRef} className="fixed will-change-transform w-[300px] h-[300px] blur-[80px] opacity-50 sm:w-[350px] sm:h-[350px] sm:blur-[100px] sm:opacity-70 md:w-[400px] md:h-[400px] md:blur-[100px] md:opacity-70 bottom-[-100px] left-[-35px] rounded-full bg-gradient-to-tr from-[#003566] via-[#001D3D] to-[#00A6FB] z-[-1]" />
        <span ref={rightCircleRef} className="fixed will-change-transform w-[250px] h-[250px] blur-[60px] opacity-50 sm:w-[300px] sm:h-[300px] sm:blur-[80px] sm:opacity-70 md:w-[400px] md:h-[400px] md:blur-[100px] md:opacity-70 top-[40px] right-[-90px] rounded-full bg-gradient-to-bl from-[#003566] via-[#001D3D] to-[#00A6FB] z-[-1]" />
      </div>

      {/* Hero Section */}
      <main ref={heroRef} className="w-full mt-30 lg:mt-35 py-16 sm:py-24 md:py-32 px-4 sm:px-6 xl:px-0">
        <div className="mx-auto w-full max-w-[700px] xl:max-w-[1100px] flex flex-col lg:flex-row gap-4 lg:justify-start lg:items-start xl:text-left md:items-center md:text-center">
          <div>
            <h1 ref={headlineRef} className="text-3xl md:text-5xl font-bold text-black leading-tight mb-5">
            ...
            <div ref={ctaRef} className="mt-20 flex gap-2 lg:gap-4 md:items-center md:justify-center xl:items-start xl:justify-start">
              <CTA2 />
              <CTA1 />
            </div>
          </div>

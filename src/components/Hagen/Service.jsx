...
const stackItems = [
  ...
  },
  {
    ...
    descMobile: 'Schnell, responsiv - auf jedem Gerät',
    descDesktop: 'Schnell, responsiv - funktioniert auf jedem Smartphone, kein Besucher springt ab',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#003566" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 flex-shrink-0">
    ...
    descMobile: 'Klar formuliert - Besucher fragen an',
  ...
  },
  {
    ...
    descDesktop: 'Kunden aus Hagen & Umgebung finden Sie - bevor sie zur Konkurrenz scrollen',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#003566" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 flex-shrink-0">
    ...
    descMobile: 'Echter Betrieb aus Hagen - sofort erkennbar',
    descDesktop: 'Elemente die zeigen: hier ist ein echter Betrieb aus Hagen - kein anonymes Unternehmen',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#003566" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 flex-shrink-0">
...
const valueBadges = [
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#003566" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.37 2 2 0 0 1 3.6 1.18h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.82a16 16 0 0 0 6.29 6.29l.95-.95a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
      </svg>
    ),
      ...
      <div className="mx-auto w-full max-w-[700px] xl:max-w-[860px]">
        ...
        <div ref={dreamRef} className="border-l-[3px] border-[#003566] bg-[#003566]/[0.04] px-4 sm:px-5 py-4 mb-8 sm:mb-10">
          ...
          <p className="text-[13px] sm:text-[15px] font-bold text-[#000814] leading-relaxed">
            Ihr Telefon klingelt - ein Interessent aus Hagen.<br />
        ...
        <div className="border border-[#003566]/20">
          ...
          <div ref={headRef} className="p-5 sm:p-8 border-b border-[#003566]/10">
            ...
            <p className="text-[13px] sm:text-[14px] text-[#000814]/55 leading-relaxed border-l-[2.5px] xl:pr-50 border-[#003566] pl-4">
              Interessenten in Hagen & Umgebung finden Sie bei Google, verstehen sofort Ihr Angebot -
              und{' '}
          ...
          <div ref={valueRef} className="p-5 sm:p-8 border-b border-[#003566]/10">
            ...
            <div className="flex flex-wrap gap-2">
              {valueBadges.map((b, i) => (
                <div
                  key={i}
                  className="w-fit inline-flex items-center gap-2 bg-gradient-to-r from-[#003566]/8 via-[#001D3D]/5 to-[#00A6FB]/8 backdrop-blur-sm border border-[#003566]/15 rounded-full px-4 py-2 shadow-sm"
                >
          ...
          <div ref={bonusRef} className="p-5 sm:p-8 border-b border-[#003566]/10 bg-[#003566]/[0.04] flex gap-3 sm:gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-[11.5px] sm:text-[12px] text-[#000814]/48 leading-relaxed">
                <span className="sm:hidden">Damit Ihre Website sofort Besucher bekommt - fertig vorbereitet.</span>

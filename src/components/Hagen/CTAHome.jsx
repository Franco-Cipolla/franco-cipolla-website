  ...
  return (
    ...
    >
      <h2 className="cta-animate text-2xl md:text-3xl lg:text-4xl font-bold mb-6">
        Verliert Ihre Website Kunden in Hagen? <br />
        Lassen Sie uns mich prüfen – unverbindlich.
      </h2>
      ...
      <p className="cta-animate text-base sm:text-lg mb-6 max-w-xl mx-auto">
        ...
        und wie Sie daraus <strong>messbar mehr Neukunden aus Hagen</strong> gewinnen. <br /><br />

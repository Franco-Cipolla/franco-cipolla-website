...
const Hero = ({ onCTAClick }) => {
  return (
    <section className='w-full relative flex flex-col px-4'>
      ...
      <h1 className='font-black text-center mt-20 text-[32px] text-[#428EFF]'>
        Website-Check: Verschenkst du täglich Kunden?
      </h1>

      <p className='text-center font-bold text-[15px] mt-10 text-black/75'>
        Hol dir meine kostenlose Website-Checkliste und entdecke, ob deine Seite die entscheidenden Elemente hat,
        um Besucher in zahlende Kunden zu verwandeln.
      </p>
      ...
      <div className='my-10 pb-10 mx-auto'>
        <ChecklistSichernCTA onClick={onCTAClick} />
      </div>
    </section>
  )
}

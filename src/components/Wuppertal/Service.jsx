...
const stackItems = [
  ...
  },
  {
    ...
    descDesktop: 'Kunden aus Wuppertal & Umgebung finden Sie - bevor sie zur Konkurrenz scrollen',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#003566" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 flex-shrink-0">
    ...
    descMobile: 'Echter Betrieb aus Wuppertal - sofort erkennbar',
    descDesktop: 'Elemente die zeigen: hier ist ein echter Betrieb aus Wuppertal - kein anonymes Unternehmen',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="#003566" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4 flex-shrink-0">
      ...
      <div className="mx-auto w-full max-w-[700px] xl:max-w-[860px]">
        ...
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="text-[15px] md:text-lg text-[#000814] max-w-2xl mx-auto">
            ...
            <span className="hidden md:inline">Für lokale Betriebe in Wuppertal & Umgebung, die Anfragen wollen - ohne auf Empfehlungen zu warten.</span>
          </p>
        </div>
        ...
        <div ref={dreamRef} className="border-l-[3px] border-[#003566] bg-[#003566]/[0.04] px-4 sm:px-5 py-4 mb-8 sm:mb-10">
          ...
          <p className="text-[13px] sm:text-[15px] font-bold text-[#000814] leading-relaxed">
            Ihr Telefon klingelt - ein Interessent aus Wuppertal.<br />

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-[#001D3D] to-[#003566] rounded-3xl p-10 text-center text-white shadow-xl mb-20">
          ...
          <p className="text-white/90 max-w-3xl mx-auto leading-relaxed">
            ...
            um Besucher strukturiert <strong>in Anfragen zu führen</strong>.  <br/> <br/> <strong>Aktuell Inklusive Bonus (im Wert von 300€): </strong> Website-Besucher-Startpaket. 2 fertige Social-Media-Posts + kurzes Video, um Besucher auf Ihre Website zu lenken. <span className="italic">Bonus nur für die nächsten 3 Kunden inklusive!</span>
          </p>

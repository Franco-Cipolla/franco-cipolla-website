  ...
  const steps = [
    {
      ...
      title: 'Briefing & Zielgruppe',
      description:
        'Wir klären, wer Ihre besten Kunden in Wuppertal sind, welche Probleme sie haben und was ihre Wünsche sind.',
    },
    {
      icon: <FaDraftingCompass className="text-[#00A6FB] w-6 h-6 md:w-8 md:h-8" />,
      title: 'Struktur & Klarheit',
      description:
        'Eine klare Seitenlogik sorgt dafür, dass Besucher sofort verstehen, was Sie anbieten, für wen es relevant ist und wie sie Kontakt aufnehmen.',
    },
    {
      icon: <FaCode className="text-[#00A6FB] w-6 h-6 md:w-8 md:h-8" />,
      title: 'Entwicklung & Conversion',
      description:
        'Schnelle, responsive Website, optimiert für lokale Suchanfragen und Conversion – damit Besucher zu Anfragen werden.',
    },
    {
      icon: <FaRocket className="text-[#00A6FB] w-6 h-6 md:w-8 md:h-8" />,
      title: 'Launch & Tracking',
      description:
        'Live-Schaltung, Besuchertracking und ein klarer Überblick: Sie sehen genau, wie viele Anfragen Ihre Website generiert.',
    },
    {
      icon: <FaTools className="text-[#00A6FB] w-6 h-6 md:w-8 md:h-8" />,
      title: 'Optimierung & Pflege',
      description:
        'Optional: monatliche Optimierungen, Updates und Anpassungen – damit Ihre Website dauerhaft performt und wächst.',
    },
  ];
    ...
    >
      <div className="max-w-7xl mx-auto text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
          Ihr Weg zu planbaren Kundenanfragen in Wuppertal
        </h2>
        <p className="text-lg text-[#000814]/80 max-w-3xl mx-auto">
          Mein klarer Prozess verwandelt Ihre Website in ein Vertriebssystem,
          das Interessenten gezielt in Anfragen aus Wuppertal & Umgebung führt.
        </p>
      </div>
...
export default WuppertalProcessSection;

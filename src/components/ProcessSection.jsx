      ...
      <div className="mx-auto w-full max-w-[700px] xl:max-w-[860px]">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-base md:text-lg text-[#000814] max-w-2xl mx-auto">
            <span className="md:hidden">Ich arbeite gezielt mit lokalen Betrieben aus Ennepetal & Umgebung, damit Ihre Kunden Sie wählen, bevor sie zur Konkurrenz gehen.</span>
            <span className="hidden md:inline">Ich arbeite gezielt mit lokalen Betrieben aus Ennepetal & Umgebung, damit Ihre Kunden Sie wählen, bevor sie zur Konkurrenz gehen. Kein langer Prozess. Ihr Aufwand ist minimal. </span>
          </p>
        </div>
